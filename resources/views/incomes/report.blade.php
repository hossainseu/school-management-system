...
@section('content')
    ...
    <div class="page-header">
        ...
        <div>
            <h1>Income Report</h1>
            <p>View income summary, category breakdown and detailed records.</p>
        </div>
    ...
    <div class="card search-card">
        ...
        >
            ...
            <input
                ...
                placeholder="Search income by title, category or reference..."
            >
    ...
    <div class="card table-card">
        ...
        <div class="section-header">
            ...
            <div>
                ...
                <p>
                    Detailed list of income records.
                </p>
            </div>
